...
export const fetchHomePageProducts = createAsyncThunk("product/fetchHomePageProducts", async (_,{rejectWithValue}) => {
    try{
...
export  const fetchCategoryProducts = createAsyncThunk("product/fetchCategoryProducts", async (url, {rejectWithValue}) => {
    try {
...
export const rateProduct = createAsyncThunk(
    "product/rateProduct",
    async ({productId, userId, rating, url, isHome}, {rejectWithValue, dispatch}) => {
        try{
...
export const queryProducts = createAsyncThunk("product/queryProducts", async(name, {rejectWithValue}) => {
    try{
...
export const fetchSingleProduct = createAsyncThunk("product/fetchSingleProduct", async({id, category}, {rejectWithValue}) =>
{
try{
